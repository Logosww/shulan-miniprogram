<template>
  <div class="bg-white flex border-0" :class="[block ? 'py-[12px]' : 'p-[12px] rounded-[8px]']" @tap="Taro.navigateTo({ url: `/pages/activity-detail/activity-detail?id=${data.id}` })">
    ...
    <div class="flex-[1] flex flex-col justify-between">
      <text class="text-[#0D0F02] text-[14px] font-bold leading-[20px] line-clamp-2 text-ellipsis">
        <text 
          class="px-[6px] text-[12px] leading-[19px] font-bold rounded-[4px] mr-[2px] align-top"
