<template>
  <ConfigProvider>
    <Container navbar-title="演出详情" :bg-style="{ backgroundColor: '#50FE82' }" disable-safe-bottom>
          ...
          <div>
            <div class="px-[16px] py-[20px] bg-white mb-[16px]">
              ...
              <div class="flex justify-between items-center" @tap="anouncementModalVisible = true">
                ...
                <image class="w-[5px] h-[10px]" src="@/assets/icon/activity-detail/right.svg" :svg="true" v-if="data?.announcement" />
              </div>
            </div>
            ...
            <div class="sticky top-0 bg-white px-[16px] z-10">
...
import Taro, { useReady, useLoad, useShareAppMessage } from '@tarojs/taro';
import { ActivityState, ActivityFeature, activityTypeMap } from '@/constants/value-enum';
import { useContentHeight, useElementHeight, useGetActivityDetail, useGetRecommendedActivities, useGetWorks, useShareActivity } from '@/composables';
